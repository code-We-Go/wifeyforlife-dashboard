...
const Header = (props: {
  ...
  return (
    <header className="sticky  top-0 z-999 flex w-full bg-primary drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 lg:hidden md:px-6 2xl:px-11">
        <div className="flex w-full justify-between items-center gap-2 sm:gap-4 lg:hidden">
  ...
  className="z-99999 block rounded-sm border border-stroke text-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
>
